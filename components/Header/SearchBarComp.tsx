  ...
  return (
    <div className="hidden lg:block">
      ...
      >
        ...
        />
        <div
          className={`absolute left-0 z-50 top-[120%] min-w-[90vw]  min-h-40 rounded-md shadow-[0_8px_30px_rgb(0,0,0,0.12)] bg-background transition-all duration-300 transform ${
            isActive
